...
class BinaryTree {
    ...
    /**maxDepth() returns the max depth of the tree, that is
    ...
    /**Further study! areCousins(node1, node2): determine whether two nodes are cousins
    ie- are at the same level but have different parents */
   ...
   * of two nodes in a binary tree. */
   ...
   lowestCommonAncestor(node1, node2, currentNode=this.root) {
       ...
       //if neighter left nor right is null, currentNode is the ancestor
